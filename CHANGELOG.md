...
- Resultado: **13 provas de calibração, 11 rodando ponta a ponta** com round-trip íntegro — 3 Integradoras (50 questões cada), 5 SOI (15 cada: 13 fechadas + 2 discursivas) e 3 HAM (10 cada: 8 + 2). As duas de 2022.2 bloqueiam com diagnóstico. `testar.mjs`: 64 → 111 verificações.
