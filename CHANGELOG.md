...
- Verificado: **13 e2e novos** (`grifar-texto.spec.ts`, incluindo grifo sobrevivendo ao F5 e alternativa não sendo marcada ao grifar) e **21 unitários** da álgebra de intervalos e da serialização. Suíte unitária inteira verde (895) e build de produção limpo.
