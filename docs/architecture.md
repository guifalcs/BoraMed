...
## ADR-029: Questões abertas — correção por IA plugável, nota por pontos sem backfill
...
## ADR-030: Equivalência de questões (dedup abertas×fechadas) + flag de revisão de conversão
