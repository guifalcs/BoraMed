-- Distribuição por cidade passa a trazer também quantos daqueles usuários
-- têm assinatura ativa, para o tooltip do gráfico do dashboard admin.
-- "Assinante" usa a mesma regra de tem_assinatura_ativa: authorized dentro da
-- validade, ou cancelled ainda em carência.
