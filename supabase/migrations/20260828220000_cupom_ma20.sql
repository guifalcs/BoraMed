...
--
-- Mesma configuração do YAS20 (20260811004404) e MARIBRASIL (20260813205827),
-- só muda o código e a descrição: `plano_id = null` vale para qualquer plano
-- ativo, `max_por_usuario = 1`, `max_usos = null` (sem teto global) e sem
-- `expira_em` (vale até ser desativado manualmente com ativo = false).
--
