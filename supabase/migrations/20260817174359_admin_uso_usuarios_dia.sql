-- admin_get_uso_usuarios_dia — detalhe de uso por usuário num dia (painel admin).
-- (Materializada do histórico do prod: aplicada via MCP em 17/08, arquivo local criado depois.)
